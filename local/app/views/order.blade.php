                        ...
                        <ul id="slider3">
                            <?php
                                        ...
                                        echo "</br>";
                                            ...
                                            if($order->image==NULL){
                                                echo '<img style="height:135px;" src="'.$order->imageLB.'" />';
                                            }else
                    ...
                    <section id="section-shape-2">
                        <ul id="slider1">
                                    <?php
                                        ...
                                        echo "</br>";
                                            echo '<img alt="" class="veiw-img" />';
                                            echo '<img style="height:135px;" src="'. URL::asset('img/upload/'.$maker->image).'" />';
                                            echo '<div class="biseller-name">';
                                                echo "<b>";
                                                echo "$maker->name";
                                                echo '<br>';
                    ...
                    <section id="section-shape-3">
                        <ul id="slider">
                                    <?php
                                        ...
                                        echo '<div class="biseller-column">';
                                            echo '<div class="biseller-name">';
                                                echo "<img style ='width:200px; height:200px;' src='$sellers->image' />";
                                                echo '<br>';
                                                echo "<b>";
                                                echo "$sellers->name";
                                                echo "</b>";
                                            ...
                                            echo '<div class="add2cart">';
                                                ...
                                                echo '<span>';
                                                echo HTML::link("viewProducts/{$sellers->fbId}",'VIEW PRODUCTS');
                                                echo '</span>';
                                            echo '</div>';
                                       echo '</div>';
                                        echo '</li>';               
