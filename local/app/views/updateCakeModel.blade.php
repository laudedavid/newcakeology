...
@if($_SESSION['fixOrder']==1)
    <input required  type = "cakeInfoAction" id ="cakeInfoAction" name = "cakeInfoAction"   value="Buy" />
    <input required  type = "Sellers" id ="Sellers" name = "Sellers"  value="{{$cakeInfo->userfbId}}" />
@endif
...
<!-- <span class="desc animate"> Layers  -->
  <span class="desc animate" style="width:200px; top:-30px">
    ...
    {{ Form::open(array('url' => 'findLayer2','files'=>true)) }}
    Layers{{ Form::select('findLayer', array('BaseLayer' => 'BaseLayer', 'Toppers' => 'Toppers', 'Borders' => 'Borders'), Input::old('findLayer'), array('class' => 'form-control','id' => 'findLayer')) }}
                                      ...
                                      <div id="actionSelector" class="form-group"> 
                                         ...
                                         @endif
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text('name', $cakeInfo['name'], array('class' => 'form-control','id'=>'cake_name')) }}
                                                </div>

                                                <div class="form-group">
                                                    {{ Form::label('price', 'Price') }}
                                                    {{ Form::text('price', $cakeInfo['price'], array('class' => 'form-control','id'=>'cake_price')) }}
                                                </div>
                                                <div class="form-group">
                                                    {{ Form::label('category', 'Category') }}
                                                    {{ Form::select('category', array($cakeInfo['category'] => $cakeInfo['category'], 'Birthday' => 'Birthday', 'Wedding' => 'Wedding', 'Anniversary' => 'Anniversary', 'Others' => 'Others'), Input::old('category'), array('class' => 'form-control','id'=>'cake_category')) }}
                                                </div>
                                                <div class="form-group">
                                                    {{ Form::label('description', 'Description') }}
                                                    {{ Form::textarea('description', $cakeInfo['description'], array('class' => 'form-control','id'=>'cake_description')) }}
                                                </div>
...
function printScreen() {
                ...
                var cake_name           = $("#cake_name").val(),
                    ...
                    seller    = $("#Sellers").val(),
                     ...
                     alert(cakeInfoAction);

                $.ajax({
                    url: '/saveUpdateCakeModelAndPrintscreen',
                    type: 'POST',
...
<?php is_array($layers = array('choosebox','layer1', 'layer2', 'layer3','topper1','topper2','topper3','borderlayer1lower','borderlayer1upper','borderlayer2lower','borderlayer2upper','borderlayer3upper','borderlayer3lower')); 
$boolfordesign=0;
